...
MODOS.addEventListener("click", () => {
    ...
    if (event.target === ACTIVAR_ENCRIPTADOR) {
        ...
        //Condicinal que remueve el elemento CONTENEDOR_BOTON_1 si la CONSOLA_ENTRADA cuenta con el
        if ([...CONSOLA_ENTRADA.childNodes].includes(CONTENEDOR_BOTON_1)) {
